...
# append or create a single, shared dataframe, stacking author attributes on top of publication attributes
...
coauthorship_net <- make_bipartite_graph(types = type, edges = edge_numeric, directed = FALSE)
